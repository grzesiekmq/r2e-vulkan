...
const uint32_t height = 600;
    ...
    bool createDevice() {
        ...
        gfxQueue = device->getQueue(findQueueFamilies(gpu).gfxFamily.value(), 0);
        presentQueue = device->getQueue(findQueueFamilies(gpu).presentFamily.value(), 0);
    ...
    bool createSurface() {
        ...
        glfwCreateWindowSurface((VkInstance)*instance, window, nullptr, &surf);
